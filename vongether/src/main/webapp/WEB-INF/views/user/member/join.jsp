				...
				<div class="well">
					...
					<form id="joinForm" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-11">
									<input type="text" class="form-control" id="mBirth" name="mBirth"
										placeholder="생년월일 (입력 예: 2000-12-01)" readonly="readonly">
								</div>
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 control-label">ROLE_USER로 기입해주세요</label>

                                <div class="col-lg-11">
                                    <input type="text" class="form-control" id="mRole" name="mRole"
							...
							<div class="form-group">
								<div class="col-lg-11 col-lg-offset-1">
									<input id="joinBtn" type="button" class="btn btn-primary" value="확인"> <a
